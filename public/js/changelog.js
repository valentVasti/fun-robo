...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // fetchChangeLog();
  asyncFetchChangeLog();
  var testAnimation = document.getElementById("test-animation");
...
var asyncFetchChangeLog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var preloader, recentActivitiesContainer, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          preloader = document.getElementById("preloader");
          recentActivitiesContainer = document.getElementById("activity-container");
          console.log(count++);
          count++;
        ...
        case 18:
          ...
          if (data.length > window.localStorage.getItem("countChangeLog")) {
            recentActivitiesContainer.style.display = "none";
            preloader.style.display = "flex";
            window.localStorage.setItem("oldCountChangeLog", window.localStorage.getItem("countChangeLog"));
            window.localStorage.setItem("countChangeLog", data.length);
            setRecentActivities(data);
          }
          setTimeout(function () {
  ...
  return function asyncFetchChangeLog() {
...
function fetchChangeLog() {
  ...
  var recentActivitiesContainer = document.getElementById("activity-container");
  count++;
  if (count * intervalTime < maxDuration) {
...
function setRecentActivities(data) {
  ...
  if (firstTime == "true") {
    ...
    var oldCountChangeLog = window.localStorage.getItem("oldCountChangeLog");
    ...
    // in
    for (var _i = 0; _i < differenceChangeLog; _i++) {
      var log = data[0];
      console.log("jalan ke:", _i);
      var activityItem = document.createElement("div");
      activityItem.classList.add("activity-item");
      var activityIcon = document.createElement("div");
      activityIcon.classList.add("activity-icon");
      ...
      var existingFirstChild = recentActivitiesContainer.firstElementChild;
      var index = Array.from(recentActivitiesContainer.children).indexOf(existingFirstChild);
      console.log("Index of the first exist child element:", index);
      activityItem.append(activityIcon, activityDetail);
      recentActivitiesContainer.insertBefore(activityItem, existingFirstChild);
    }
  }
}
function formatDate(dateData) {
  ...
  var month = pad(date.getUTCMonth() + 1); // Month starts from zero, so add 1
