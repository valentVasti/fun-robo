document.addEventListener("DOMContentLoaded", function () {
    ...
    const img_1 = document.getElementById("article_img_1");
    const img_2 = document.getElementById("article_img_2");
    const img_3 = document.getElementById("article_img_3");
    const count = radioButtons.dataset.count;
    const children = radioButtons.querySelectorAll("input");
    ...
    if (count != 0) {
        ...
        children.forEach((radioButton, index) => {
